	...
	<div class="row">
	  <div class="small-11 small-centered large-12 columns">
	      <h3 class="pshadow hideme">Introduction</h3>
	      	<hr>
	          <p>KINOKI International Student Film Festival was founded in 2004 by students from the Universidad Iberoamericana to provide exposure for film students across the world. <br>
The name KINOKI is a word based in kino-pravda, a concept derived from the philosophy of soviet filmmaker Dziga Vértov. This philosophy consisted in capturing fragments of reality which, that when organized together, showed a deeper truth that could not be seen or reached by the naked eye.<br>
	...
	<div class="row">
	  <div class="small-11 small-centered large-12 columns">
	      <h3 class="pshadow hideme">Call for entries<p class='bolder'>Guest of honor: Denmark</p></h3>
	          ...
	          <p>
	          Complete guidelines are available in the <a data-scroll-nav='3'>Submissions</a> section. In case of further questions or concerns, visit our <a data-scroll-nav='5'>FAQ</a> or contact us at <strong>contacto@festivalkinoki.com</strong>
	          </p>
	 </div>
	</div>  
...
<li>Honorary mention for documentary short film: B-Boy - Abraham Escobedo.</li>
<li>Honorary mention for experimental short film: This is the closest to how footage looked - Yuval Hameiri.</li>
<li>Best edition: Ceremony - Noa Levin.
		        ...
		        <div class="content" id="panel2-2012">
		          <p>
		          The winners of this year's edition were:<br>
		          <ul>
...
During this year’s inauguration, the theater company Humanicorp (a hybrid of athletes, dancers and creators) presented one of its shows in which a reinterpretation of worldwide known films were represented through dance and circus arts. <br>
<br>
...
Thanks to the festival’s exposure, this edition had the participation of different locations outside Universidad Iberoamericana: “Hotel Virreyes”, located in Mexico City’s historic center, was used for the inauguration party, and “Galería O” was used for the closure party. The drive-in cinema event was also implemented as an alternate form of screening. <br>
...
General Director
		      ...
		      <div class="content" id="panel2-2004">
		          <p>
			        The idea was initially conceived by the student José Luis Aranda. Being the first year of the project, short film exhibitions were held only at Universidad Iberoamericana’s facilities, because it was intended to be a local project. However, the festival was very well received and had many accomplishments that put it on the map: 
			          <ul>
<li>The winning short film was exhibited in FICCO 2005.</li>
<li>Three of the finalist short films were broadcasted at Televisa and Telehit’s “Espacio 2005”.</li>
<li>The Rockefeller Foundation in New York nominated the two directors of KINOKI’s winning short film for its “Program for Media Arts” scholarship.</li>
<li>Three of the winning short films were broadcasted by Canal 22 during the show “Corto y Queda”, along with an interview with the Director of the Communication Department and the Coordinator of Film Area of the Universidad Iberoamericana. </li>
